    ...
    <Layout>
      ...
      >
        ...
        <section id="new-system">
          ...
          <P paragraph>
            GCSEs were introduced in 1988 - 31 years ago from today, and 19
            years before the first iPhone was released. They were introduced
            before the modern internet, and computers, and most technology. They
            were designed for an older society, unlike ours today. And they need
            to be updated.
          </P>
          <P paragraph>
            Students today face a multitude of different scenarios and issues
            which noone could have foreseen in 1988, such as social media
            "perfectionists". Countless students feel pressured into succeeding
            and achieving above a grade 9 (A* equivalent), even when it is
            almost impossible for them to gain a grade 6.
          </P>
          <P paragraph>
            Many senior school leaders, the NSPCC, and Childline are concerned
            that the new format GCSEs are far too stressful and are leading to
            teenage mental health crises. In 2016, the average GCSE student sat
            18 exams at a total of 24 hours 30 minutes. Contrastingly, in 2019
            the same student would sit 22 exams totalling 33 hours.{" "}
            <strong>
              These 33 hours, at age 16, are what defines young peoples' lives
              nowadays.
            </strong>
          </P>
          <P paragraph style={{ fontWeight: 600 }}>
            I can guarantee that we will overhaul our education system, bringing
            it up-to-day with modern culture and technology, redefine the
            national curriculum, and invest in mental health support for young
            people.
          </P>
        </section>
